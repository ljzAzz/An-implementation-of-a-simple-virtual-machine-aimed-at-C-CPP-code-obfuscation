...
@.str = private unnamed_addr constant [13 x i8] c"hello world2\00", align 1
...
define dso_local noundef i32 @main() #6 {
  ...
  %4 = call { i64, double } @_Z7returnAii(i32 noundef 1, i32 noundef 2)
  %5 = getelementptr inbounds { i64, double }, ptr %3, i32 0, i32 0
  %6 = extractvalue { i64, double } %4, 0
  store i64 %6, ptr %5, align 8
  %7 = getelementptr inbounds { i64, double }, ptr %3, i32 0, i32 1
  %8 = extractvalue { i64, double } %4, 1
